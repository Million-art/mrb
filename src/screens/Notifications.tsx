...
const Notifications = () => {
  ...
  const fetchNotifications = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${API_CONFIG.API_MAIN_URL}/notifications/${telegramId}`);
  ...
  const markAsRead = async (notificationId: string) => {
    try {
      ...
      await axios.post(`${API_CONFIG.API_MAIN_URL}/notifications/${notificationId}/read`);
  ...
  const markAllAsRead = async () => {
    try {
      await axios.post(`${API_CONFIG.API_MAIN_URL}/notifications/${telegramId}/read-all`);
